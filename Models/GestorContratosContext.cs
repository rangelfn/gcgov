...
public partial class GestorContratosContext : DbContext
{
    ...
    public virtual DbSet<DespesasPorContrato> DespesasPorContratos { get; set; }

    public virtual DbSet<DotacaoOrcamentaria> DotacaoOrcamentarias { get; set; }

    public virtual DbSet<Editai> Editais { get; set; }

    public virtual DbSet<ModLicitacao> ModLicitacaos { get; set; }

    public virtual DbSet<Pagamento> Pagamentos { get; set; }

    public virtual DbSet<PessoasPorContrato> PessoasPorContratos { get; set; }
    ...
    public virtual DbSet<PortariasServidore> PortariasServidores { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=GestorContratos;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Contrato>(entity =>
        {
            ...
            entity.HasOne(d => d.UgDp).WithMany(p => p.Contratos)
                .HasForeignKey(d => d.UgDpId)
                .HasConstraintName("FK__Contratos__UgDpI__0662F0A3");
        });

        modelBuilder.Entity<DespesasPorContrato>(entity =>
        {
            entity
                .HasNoKey()
        ...
        modelBuilder.Entity<Editai>(entity =>
        {
            ...
            entity.Property(e => e.EdtLink)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.EdtNum)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.EdtTipo)
                .HasMaxLength(255)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<Pagamento>(entity =>
        {
            ...
            entity.HasOne(d => d.PgtoTipo).WithMany(p => p.Pagamentos)
                .HasForeignKey(d => d.PgtoTipoId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK__Pagamento__PgtoT__1A69E950");
        });

        modelBuilder.Entity<PessoasPorContrato>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("PessoasPorContratos");
        ...
        modelBuilder.Entity<PgtosModalidade>(entity =>
        {
            ...
            entity.Property(e => e.PgtoModNome)
                .HasMaxLength(255)
                .IsUnicode(false);
        });
        ...
        modelBuilder.Entity<PortariasServidore>(entity =>
        {
        ...
        modelBuilder.Entity<UnidadesGestora>(entity =>
        {
            ...
            entity.Property(e => e.UgCodigoId)
                .ValueGeneratedNever()
                .HasColumnName("UgCodigoID");
            entity.Property(e => e.UgCnpj)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.UgContato)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.UgNome)
                .HasMaxLength(255)
                .IsUnicode(false);
        });
        ...
        modelBuilder.Entity<ViewContratosPagamento>(entity =>
        {
            ...
            entity.Property(e => e.OrdemBancaria)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.PgtoModalidade)
                .HasMaxLength(255)
                .IsUnicode(false);
            entity.Property(e => e.PreparacaoPagamento)
                .HasMaxLength(255)
